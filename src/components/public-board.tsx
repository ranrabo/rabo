...
function DayExtras({ selectedDate, selectedDay, blocks, today, onSelectDate }: { selectedDate: Date; selectedDay: number; blocks: BlockWithMember[]; today: string; onSelectDate: (date: Date) => void }) {
